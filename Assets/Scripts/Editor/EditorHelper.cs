...
public static class EditorHelper
{
    ...
    public static void CreateLayer(string name)
    {
        ...
        for (var i = 0; i < propCount; i++)
        {
            ...
            //built-in, 이미 다른 레이어가 자리를 차지하고 있다면.
        ...
        if (firstEmptyProp == null)
        {
            Debug.LogError($"레이어가 최대 갯수에 도달하였습니다. 그래서 {name}을 생성하지 못하였습니다.");
            return;
        }
    ...
    /// <summary>
    /// GameObject에 레이어를 세팅합니다. 원하면 자식들도 전부 다 세팅합니다.
    /// </summary>
