...
public class InspectorHelper
{
    ...
    public static void DrawArrowTypeSelection(TrafficHeadquater trafficHeadquarter)
    {
        trafficHeadquarter.arrowDrawType = (TrafficHeadquater.ArrowDraw)
        ...
        if (trafficHeadquarter.arrowDrawType != TrafficHeadquater.ArrowDraw.Off)
        {
